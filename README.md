...
<p align="center">
  <img src="docs/screenshots/fleet.jpg" width="30%" alt="Fleet: the CRRC eT12 MAX and Enviro200, with photos from the AT Metro Wiki">
  <img src="docs/screenshots/model.jpg" width="30%" alt="A model's page: the CRRC eT12 MAX, its specs, history and fleet numbers">
...
- **Fleet dex**: every model that pulls up at your Home stops gets spotted and
  counted, from "Fresh at the kerb" to "Ultimate spotter". The rest stay
  mysteries until you see one.
